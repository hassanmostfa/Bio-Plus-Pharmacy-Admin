...
export const { useLoginUserMutation, useGetUserProfileQuery, useGetAdminsQuery , useCreateUserMutation, useUpdateUserMutation, useDeleteUserMutation, useGetUsersQuery, useGetUserAddressesQuery} = apiService;
